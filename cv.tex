...
\hypersetup{
  ...
  urlcolor = black,
  pdfauthor = {\name},
  pdfkeywords = {software engineering, site reliability engineering, problem solving, computer science},
...
\bigskip
\textsc{Keywords}:
Java, Scala, cats, cats-effect, ZIO, AWS, Platform Engineering, CI/CD Engineering, Kubernetes, GitHub Actions, Containerization.

\section*{Employment}
\begin{no-indent-itemize}
  \item \textsc{Intent HQ}, Barcelona, Site Reliability Engineer, Apr 2021--Sept 2023.
  \begin{itemize}
    \item\bullet Lead software platform integration for a multi-million dollar on-premise software development and deployment project at a Tier 1 US telco
    \item\bullet Helped developing a crossplane-powered self-serve platform for developers.
...
\section*{Education}
\begin{no-indent-itemize}
  \item Computer Science - Software Development, IHK, 2004--Jul 2007
\end{no-indent-itemize}
