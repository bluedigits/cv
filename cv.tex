...
\bigskip
\textsc{Keywords}: 
Scala, SBT, Java, Spring, Maven, AWS, Akka Cluster, Apache Kafka, Apache Solr, Docker, Kubernetes, NoSQL, Microservices, Linux.
...
\begin{no-indent-itemize}
  \item Functional Programming Principles in Scala by EPFL on Coursera 
        (\href{http://tinyurl.com/y4fmkg8s}{http://tinyurl.com/y4fmkg8s}), score~100\%
\end{no-indent-itemize}
